...
///
/// This trait will be automatically implemented if you enable the `derive` feature and add `#[derive(cracode::Encode)]` to your trait.
///
/// # Implementing this trait manually
///
/// If you want to implement this trait for your type, the easiest way is to add a `#[derive(cracode::Encode)]`, build and check your `target/generated/cracode/` folder. This should generate a `<Struct name>_Encode.rs` file.
///
/// For this struct:
///
/// ```
...
/// #     pub y: f32,
/// # }
/// impl cracode::Encode for Entity {
///     fn encode<E: cracode::enc::Encoder>(
///         &self,
///         encoder: &mut E,
///     ) -> core::result::Result<(), cracode::error::EncodeError> {
///         cracode::Encode::encode(&self.x, encoder)?;
///         cracode::Encode::encode(&self.y, encoder)?;
///         Ok(())
///     }
/// }
/// ```
