...
/// # let some_reader = cracode::de::read::SliceReader::new(slice);
/// use cracode::de::{DecoderImpl, Decode};
/// let mut context = ();
/// let mut decoder = DecoderImpl::new(some_reader, cracode::config::standard(), &mut context);
