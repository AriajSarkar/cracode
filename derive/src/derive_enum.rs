...
impl DeriveEnum {
            ...
            .body(|fn_body| {
                ...
                fn_body.group(Delimiter::Brace, |match_body| {
                    ...
                    for (variant_index, variant) in self.iter_fields() {
                        ...
                        //      cracode::Encode::encode(a, encoder)?;
                        //      cracode::Encode::encode(b, encoder)?;
                        //      cracode::Encode::encode(c, encoder)?;
                        // }
    ...
    fn invalid_variant_case(&self, enum_name: &str, result: &mut StreamBuilder) -> Result {
        ...
        // we'll be generating:
        // variant => Err(
        //    cracode::error::DecodeError::UnexpectedVariant {
        //        found: variant,
        //        type_name: <enum_name>
        //        allowed: ...,
        //    }
        ...
        // - cracode::error::AllowedEnumVariants::Range { min: 0, max: <max> }
        //   if we have no fixed value variants
        // - cracode::error::AllowedEnumVariants::Allowed(&[<variant1>, <variant2>, ...])
        ...
        result.group(Delimiter::Parenthesis, |err_inner| {
            err_inner
                .push_parsed(format!("{}::error::DecodeError::UnexpectedVariant", crate_name))?;
