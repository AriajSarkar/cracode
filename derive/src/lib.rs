...
#[proc_macro_derive(Encode, attributes(cracode))]
...
fn derive_encode_inner(input: TokenStream) -> Result<TokenStream> {
    ...
    generator.export_to_file("cracode", "Encode");
    generator.finish()
}

#[proc_macro_derive(Decode, attributes(cracode))]
...
fn derive_decode_inner(input: TokenStream) -> Result<TokenStream> {
    ...
    generator.export_to_file("cracode", "Decode");
    generator.finish()
}

#[proc_macro_derive(BorrowDecode, attributes(cracode))]
...
fn derive_borrow_decode_inner(input: TokenStream) -> Result<TokenStream> {
    ...
    generator.export_to_file("cracode", "BorrowDecode");
    generator.finish()
}
